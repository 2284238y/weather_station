<?php
//index.php
$connect = mysqli_connect("localhost", "root", "Your password", "sensor_log");

 
  $query = '
  SELECT sensor_value, UNIX_TIMESTAMP(timestamp) AS datetime  
  FROM table_sensor_log 
  WHERE UNIX_TIMESTAMP(timestamp)>= '.time().'-24070 AND sensor_id = 2
...
<html>
 ...
 <body>
  <div class="page-wrapper">
   ...
   <a href="http://192.168.0.23/test/index.php">Temperature link</a>
  </div>
 </body>
</html>
